                        ...
                        <dl class="chat-main">
                          ...
                          <dd>
                            <dl class="chat-head">
                              <dt>
                                <img
                                  src="./images/CgpOIF5zHE6AO-4cAAClHXSH0dU730.jpg"
                                  alt="hr头像"
                                  class="hr-pic"
                                />
                              </dt>
                              <dd>
                                <div class="hr-name">dkp</div>
                                <div class="hr-position"></div>
                              </dd>
                              <dd class="tip-text">
...
<script>
import { reqPositions, reqCompanys } from '@/api'
