          ...
          <div class="form_body" data-view="passwordLogin">
            <form class="active" action="javascript:;">
              ...
              >
                ...
                />
                 <span data-valid-message="" class="input_tips" ref="tipsPhone">请输入已验证手机/邮箱</span>
              </div>
              <div
                class="input_item clearfix"
              ...
              >
                ...
                />
                <span data-valid-message="" class="input_tips"  ref="tipsPassword">密码错误</span>
